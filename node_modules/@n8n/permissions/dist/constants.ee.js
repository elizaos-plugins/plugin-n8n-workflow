...
exports.PROJECT_CHAT_USER_ROLE_SLUG = exports.PROJECT_VIEWER_ROLE_SLUG = exports.PROJECT_EDITOR_ROLE_SLUG = exports.PROJECT_ADMIN_ROLE_SLUG = exports.PROJECT_OWNER_ROLE_SLUG = exports.API_KEY_RESOURCES = exports.RESOURCES = exports.DEFAULT_OPERATIONS = void 0;
...
exports.RESOURCES = {
    ...
    credential: ['share', 'shareGlobally', 'move', ...exports.DEFAULT_OPERATIONS],
    ...
    apiKey: ['manage'],
    credentialResolver: [...exports.DEFAULT_OPERATIONS],
};
exports.API_KEY_RESOURCES = {
    ...
    execution: ['delete', 'read', 'retry', 'list', 'get'],
    credential: ['create', 'update', 'move', 'delete'],
    sourceControl: ['pull'],
    workflowTags: ['update', 'list'],
};
...
exports.PROJECT_CHAT_USER_ROLE_SLUG = 'project:chatUser';
