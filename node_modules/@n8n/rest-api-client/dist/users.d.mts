...
import { FeatureFlags, IPersonalizationSurveyAnswersV4, IUserSettings } from "n8n-workflow";
import { LoginRequestDto, PasswordUpdateRequestDto, Role, SettingsUpdateRequestDto, User, UserUpdateRequestDto, UsersList, UsersListFilterDto } from "@n8n/api-types";
...
declare function deleteUser(context: IRestApiContext, {
  id,
  transferId
}: {
  id: string;
...
declare function getInviteLink(context: IRestApiContext, {
  id
}: {
  id: string;
}): Promise<{
...
declare function generateInviteLink(context: IRestApiContext, {
  id
}: {
  id: string;
}): Promise<{
...
declare function getPasswordResetLink(context: IRestApiContext, {
  id
}: {
  id: string;
}): Promise<{
...
declare function updateGlobalRole(context: IRestApiContext, {
  id,
  newRoleName
}: UpdateGlobalRolePayload): Promise<IUserResponse>;
//#endregion
export { updateCurrentUser as C, updateOtherUserSettings as D, updateGlobalRole as E, validatePasswordToken as O, submitPersonalizationSurvey as S, updateCurrentUserSettings as T, loginCurrentUser as _, IPersonalizationSurveyAnswersV3 as a, setupOwner as b, IUserResponse as c, deleteUser as d, generateInviteLink as f, login as g, getUsers as h, IPersonalizationSurveyAnswersV2 as i, validateSignupToken as k, UpdateGlobalRolePayload as l, getPasswordResetLink as m, IPersonalizationLatestVersion as n, IPersonalizationSurveyVersions as o, getInviteLink as p, IPersonalizationSurveyAnswersV1 as r, IUser as s, CurrentUserResponse as t, changePassword as u, logout as v, updateCurrentUserPassword as w, signup as x, sendForgotPasswordEmail as y };
