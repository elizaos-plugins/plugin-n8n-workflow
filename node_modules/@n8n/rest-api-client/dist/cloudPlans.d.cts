...
//#region src/api/cloudPlans.d.ts
...
declare function sendUserEvent(context: IRestApiContext, eventData: {
  eventType: string;
  metadata?: Record<string, unknown>;
}): Promise<DynamicNotification>;
//#endregion
export { getCloudUserInfo as a, sendConfirmationEmail as c, getAdminPanelLoginCode as i, sendUserEvent as l, DynamicNotification as n, getCurrentPlan as o, InstanceUsage as r, getCurrentUsage as s, Cloud as t };
