...
import { type JINA_AI_TOOL_NODE_TYPE, type SERP_API_TOOL_NODE_TYPE, type INode, type ChunkType } from 'n8n-workflow';
import { z } from 'zod';
...
declare const ChatHubEditMessageRequest_base: Z.Class<{
    ...
    keepAttachmentIndices: z.ZodArray<z.ZodNumber, "many">;
    timeZone: z.ZodCatch<z.ZodOptional<z.ZodEffects<z.ZodString, string, string>>>;
}>;
